...
Donate link:https://tfsimg.alipay.com/images/mobilecodec/T1YYxoXlxcXXXXXXXX
...
七牛云存储插件：编辑器中上传图片至七牛云对象存储

该插件让你直接在编辑器页面上传图片到七牛云对象存储
...
This plugin allows you to upload images directly to the qiniu page in the editor page
After the completion of the upload automatically add pictures in the editor, do not need to set the total station CDN
Simple function, more convenient

详细介绍：  http://www.75271.com/2954.html
