$(function() {
    var uploader_btn = Qiniu.uploader({
        ...
        drop_element: 'qiniu_cloudtuchuang_div',
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
                ...
                qiniuurl = host + '/' + key;
                if (imgurl == true) {
                    var img = '<a href="' + qiniuurl + '"><img src="' + qiniuurl + '" alt="' + title + '" title="' + title + '">';
                } else {
                    var img = '<img src="' + qiniuurl + '" alt="' + title + '" title="' + title + '">';
                }
                console.log(img);
                var wpActiveEditor, editor, hasTinymce = typeof tinymce !== 'undefined',
    ...
    uploader_btn.bind('FileUploaded',
    function() {
